...
//        anotherOrder.setName("test");
//        anotherOrder.setQty(1);
//        anotherOrder.setPrice(100.50);
//        assertTrue(order.equals(anotherOrder));
//        assertEquals(order.hashCode(), anotherOrder.hashCode());
//
//        Order differentOrder = new Order();
//        differentOrder.setOrderId("54321");
//        differentOrder.setName("Phone");
//        differentOrder.setQty(1);
//        differentOrder.setPrice(300.0);
